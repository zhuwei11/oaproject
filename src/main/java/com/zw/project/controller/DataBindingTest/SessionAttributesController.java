...
import com.zw.project.pojo.User;
...
public class SessionAttributesController{
	...
	@RequestMapping(value="DataBindingTest/{formName}")
	 public String loginForm(@PathVariable String formName){
		// 动态跳转页面
		return "DataBindingTest/"+formName;
	}

	// 该方法映射的请求为http://localhost:8080/DataBindingTest/login
	@RequestMapping(value="DataBindingTest/login")
	 public String login(
		 ...
		 return "DataBindingTest/welcome";
	 }
